$(function() {
    ...
    var reportState = new ReportState({ useExpandCollapse: true, sortMostSpecificOnly: true });
    ...
    reportState.drawNewData = function(data) { 
        ...
        if (reportState.sortRowIndex != -1)
            reportState.drawData(reportBuilder.sortExpandedData(reportState.serverData, reportState.dimensionsY, reportState.sortRowIndex, reportState.sortDirection, reportState.expandedCells, reportState.mostSpecificOnly));
        else
